...
class CustomErrorFormatter extends LogFormatter {
  public formatAttributes(
    ...
    return {
      ...
      lambda: {
        awsRequestId:
          attributes.lambdaContext?.awsRequestId ?? "No lambdaContext",
        xrayTraceId: attributes.xRayTraceId ?? "No xRayTraceId",
        name: attributes.lambdaContext?.functionName ?? "No lambdaContext",
        coldStart: attributes.lambdaContext?.coldStart ?? true,
      },
