...
def do_action(event, _):
    ...
    usage_plan_id_premium = event['ResourceProperties']['UsagePlanPremiumTierId']
    usage_plan_id_platinum = event['ResourceProperties']['UsagePlanPlatinumTierId']
