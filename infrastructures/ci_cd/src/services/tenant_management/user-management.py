...
tenant_user_map_table_name = os.environ['TENANT_USER_MAP_TABLE_NAME']
tenant_details_map_table_name = os.environ['TENANT_DETAILS_TABLE_NAME']

table_tenant_user_map = dynamodb.Table(tenant_user_map_table_name)
table_tenant_details = dynamodb.Table(tenant_details_map_table_name)
